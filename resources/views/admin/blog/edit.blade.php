                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="text"
                                                ...
                                                name="category" placeholder="Enter category" value="{{ $blog->category }}">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea class="form-control form-control-lg @if ($errors->has('excerpt')) is-invalid @endif" name="excerpt"> {{ $blog->excerpt }}</textarea>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea class="js-summernote form-control-lg" id="js-summernote" name="description">{{ $blog->description }}</textarea>
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <div class="block block-themed">
                        ...
                        <div class="block-content block-content-full text-center">
                            <img class="img-avatar img-avatar-thumb" src="{{ $blog->image }}" alt="">
                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="custom-control custom-radio custom-control-inline mb-5">
                                                <input class="custom-control-input" type="radio" required
                                                    name="status" value="1"
                                                    {{ $blog->status == '1' ? 'checked' : '' }} id="check1">
                                                <label class="custom-control-label" for="check1">Active</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline mb-5">
                                                <input class="custom-control-input" type="radio" required
                                                    name="status" value="0"
                                                    {{ $blog->status == '0' ? 'checked' : '' }} id="check2">
                    ...
                    <div class="block  block-themed">
                        ...
                        <div class="block-content">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group row">
                                        <label class="col-lg-12" for="example-tags1">Meta Tags / Meta Keywords</label>
                                        <div class="col-lg-12">
                                            <input type="text"
