                ...
                <div class="col-lg-8 col-12">
                    <div class="block  block-themed">
                        <div class="block-header bg-gd-dusk">
                            <h3 class="block-title">Blog Create</h3>
                        </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="text"
                                                ...
                                                name="category" placeholder="Enter category" value="{{ old('category') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea class="form-control form-control-lg @if ($errors->has('excerpt')) is-invalid @endif" required
                                                name="excerpt" placeholder="excerpt.. (short description of workshop)">{{ old('excerpt') }}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="custom-control custom-radio custom-control-inline mb-5">
                                                <input class="custom-control-input" type="radio" required
                                                    name="status" id="check1" value="1" checked>
                                                <label class="custom-control-label" for="check1">Active</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline mb-5">
                                                <input class="custom-control-input" type="radio" required
                                                    name="status" id="check2" value="0">
